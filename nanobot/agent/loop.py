...
class AgentLoop:
    ...
    async def _process_message(
        ...
        progress_cb = on_progress or (_bus_progress if self.show_progress else None)
        ...
        # Allow the agent to choose silence — record the message but send nothing
        if NO_RESPONSE_SENTINEL in (final_content or ""):
            logger.info(f"No response chosen for {msg.channel}:{msg.sender_id}")
